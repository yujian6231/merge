...
def test(model, img, box2d_file, box3d_file,calib_path):
        ...
        for line in open(box2d_file):
            ...
            if class_load[class_num] in VEHICLES:
                ...
                location = plot_regressed_3d_bbox(
                    img_plot, proj_matrix, obj, list(dims), line[14], line[14])
    ...
    if args.mode == 'train':
        ...
        with tf.Session(graph=graph) as sess_2d:
            ...
            #FPS
                ...
                test(args.model, original_image, box2d_file ,box3d_file,calib_path )
